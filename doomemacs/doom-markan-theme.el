;;; themes/doom-markan-theme.el -*- lexical-binding: t; -*-
...
(defgroup doom-markan-theme nil
  "Options for the `doom-markan' themes."
  :group 'doom-themes)

(defcustom doom-markan-padded-modeline doom-themes-padded-modeline
  "If non-nil, adds a 4px padding to the mode-line. Can be an integer to determine the exact padding."
  :group 'doom-markan-theme
  :type '(choice integer boolean))

;;
;;; Theme definition

(def-doom-theme doom-markan
  "A dark theme inspired by bluloco dark theme"

  ;; name        default     256       16
  ((bg           '("#000000" "#000000" "black"        ))
   (fg           '("#abb2bf" "#b2b2b2" "white"        ))
   (hl-line      '("#242424" "#000000" "black"        ))
   ...
   (-modeline-pad
    (when doom-markan-padded-modeline
      (if (integerp doom-markan-padded-modeline) doom-markan-padded-modeline 4))))
...
;;; themes/doom-markan-theme.el ends here
